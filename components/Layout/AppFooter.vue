<template>
  <footer class="py-12 text-xl border-t border-solid border-neutral-600">
    <div id="footer-content" class="flex flex-row items-baseline justify-between gap-0 mx-auto px-10 max-w-[1280px] max-md:flex-col max-md:items-center max-md:gap-5">
