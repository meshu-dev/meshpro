...
const introDetails: Ref<Intro | null> = ref((await getIntroText()) || null);
</script>

<template>
  <div
    v-if="introDetails"
    class="flex flex-row justify-center items-center h-[50vh] gap-10 max-lg:flex-col"
  >
    <div>
      <div class="text-5xl max-lg:text-center">{{ introDetails.line1 }}</div>
      <div class="text-2xl mt-4 mb-8 max-lg:text-center">
        {{ introDetails.line2 }}
      </div>
